...
<?php
    foreach($this->data as $key => $value) {
        ...
        echo '<td>';
                ...
                if(!Auth::isRole($role, 5) AND !Auth::isRole($role, 4))echo '<a href="'.URL.'suratkeluar/rekamrev/'.$value['id_suratkeluar'].'"><input class=btn type=button value="Upload File"></a> ';
