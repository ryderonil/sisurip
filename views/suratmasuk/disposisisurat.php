...
$pdf->Cell(3,0.4,': '.$this->view->data['no_surat'],'R',0,'L');
$pdf->Cell(1.5,0.4,'Status',0,0,'L');
$pdf->Cell(3,0.4,': --'.$this->view->data['status'],'R',0,'L');
$pdf->Cell(1.5,0.4,'Diterima Tgl',0,0,'L');
$pdf->Cell(2.5,0.4,': '.$this->view->data['tgl_terima'],'R',1,'L');
$pdf->Cell(1.5,0.4,'Tgl Surat','L',0,'L');
$pdf->Cell(3,0.4,': '.$this->view->data['tgl_surat'],'R',0,'L');
$pdf->Cell(1.5,0.4,'Sifat',0,0,'L');
$pdf->Cell(3,0.4,': '.$this->view->data['sifat'],'R',0,'L');
$pdf->Cell(1.5,0.4,'No. Agenda',0,0,'L');
$pdf->Cell(2.5,0.4,': '.$this->view->data['no_agenda'],'R',1,'L');
$pdf->Cell(1.5,0.4,'Lampiran','BL',0,'L');
$pdf->Cell(3,0.4,': '.$this->view->data['lampiran'],'BR',0,'L');
$pdf->Cell(1.5,0.4,'Jenis','B',0,'L');
$pdf->Cell(3,0.4,': '.$this->view->data['jenis'],'BR',0,'L');
$pdf->Cell(1.5,0.4,'','B',0,'L');
$pdf->Cell(2.5,0.4,'','RB',1,'L');
$pdf->Cell(1.5,0.4,'Dari','L',0,'L');
$pdf->Cell(11.5,0.4,': '.$this->view->data['asal_surat'],'R',1,'L');
$pdf->Cell(1.5,0.4,'Perihal','L',0,'L');
$pdf->Cell(11.5,0.4,': '.$this->view->data['perihal'],'R',1,'L');
$pdf->Cell(1.5,0.4,'','BL',0,'L');
$pdf->Cell(11.5,0.4,'','BR',1,'L');

//$pdf->Image('public/images/check20-cek.png', 3, 7.08, 0.2, 0.2, 'PNG');
checkImage($pdf, 'SS', $this->view->disp[2], 3, 7.08);
$pdf->Cell(6.5,0.4,'SANGAT SEGERA','BL',0,'C');
//$pdf->Image('public/images/check20.png', 9.95, 7.08, 0.2, 0.2, 'PNG');
checkImage($pdf, 'S', $this->view->disp[2], 9.95, 7.08);
